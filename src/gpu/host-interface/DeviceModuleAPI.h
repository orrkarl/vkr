...
///     bindings>; static const std::array<uint32_t, ARG_SETS_COUNT> SETS = <sizes of each descriptor set in
///     BINDINGS array in order>; static const std::array<VkPushConstantRange, PUSH_CONSTANTS_COUNT> PUSH_ARGS
